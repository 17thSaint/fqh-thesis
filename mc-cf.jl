...
#xs_count = 200
#denss = get_density(particles,n,p,[qpart,rezz[2],rezz[3]],xs_count,1,false)
#plot(denss[1],denss[2])
#write_pos_data_hdf5("NA",mc_steps,particles,n,p,rezz,k,qpart,log_form)
#setup = rezz[2]
#logmat = get_wavefunc_fromlog(setup,n,p,qpart)[2]
#detsstf = get_log_det(logmat)
